...
Authorization Hash Key: Enter the Verification Key generated by the Authorization Verification Hash ability within your PlugnPay account.  If using Divert Currency, list each currency with its assocated key [i.e, USD:key1,BBD:key2,CAD:key3] [Must be configured to match your PlugnPay account]
...
== Upgrade Notice ==
* Upgrade is required, if your module version is below v1.1.8.3
