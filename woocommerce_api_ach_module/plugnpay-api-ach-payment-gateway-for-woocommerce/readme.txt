...
<h3>PlugnPay API ACH/eCheck Payment Gateway for WooCommerce</h3> makes your website ready to use PlugnPay's API payment method, to accept checking payments on your ecommerce store checkout page.
